...
// Body: { new_plan_id, new_pricing_cycle_id, reason, effective_at? }
// Downgrade is functionally similar to upgrade but logged separately for analytics.
export async function POST(request, { params }) {
  ...
  try {
    ...
    await logSubscriptionEvent({
      subscription_id: id, event_type: 'downgraded', actor_id: auth.userId,
    ...
    console.error('[Subscriptions] downgrade error:', e);
