  ...
  return (
    <div className="max-w-2xl mx-auto py-10 px-6 space-y-10">
      <div>
        ...
        <p className="text-sm text-gray-400 mt-1">Choose your preferred reading font, size, weight and spacing.</p>
      </div>

      {/* ── Font Family ── */}
      <section className="space-y-3">
        <h2 className="text-sm font-semibold text-gray-300 uppercase tracking-wider">Font Family</h2>
            ...
            <button
              ...
              className={`flex items-center justify-between px-4 py-2.5 rounded-xl border text-left transition-all ${
                fontFamily === key
                  ...
                  : 'border-white/[0.06] bg-white/[0.02] text-gray-400 hover:border-white/[0.15] hover:text-white'
              }`}
      ...
      {/* ── Font Size ── */}
      <section className="space-y-3">
        <h2 className="text-sm font-semibold text-gray-300 uppercase tracking-wider">Font Size</h2>
      ...
      {/* ── Font Weight ── */}
      <section className="space-y-3">
        <h2 className="text-sm font-semibold text-gray-300 uppercase tracking-wider">Font Weight</h2>
        <div className="flex flex-wrap gap-2">
      ...
      {/* ── Line Height ── */}
      <section className="space-y-3">
        <h2 className="text-sm font-semibold text-gray-300 uppercase tracking-wider">Line Height</h2>
        <div className="flex flex-wrap gap-2">
      ...
      {/* ── Live Preview ── */}
      <section className="space-y-3">
        <h2 className="text-sm font-semibold text-gray-300 uppercase tracking-wider">Live Preview</h2>
