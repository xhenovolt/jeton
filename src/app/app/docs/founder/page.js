    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">The Big Picture: Your Core Workflow</h2>
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm mb-8">
          ...
          {/* Morning */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-gray-900 mb-4 bg-yellow-50 p-3 rounded-lg border-l-4 border-yellow-500">
              MORNING (10 minutes)
            </h3>
            <div className="space-y-4 ml-4">
              <div className="p-4 bg-blue-50 rounded-lg">
                <div className="flex items-start justify-between">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">1. Check Financial Dashboard</h4>
              ...
              <div className="p-4 bg-blue-50 rounded-lg">
                <div className="flex items-start justify-between">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">2. Review Today's Follow-Ups</h4>
                    <p className="text-gray-700 text-sm">Prospects you promised to call/email today</p>
                    <p className="text-sm text-gray-600 mt-2 italic">
              ...
              <div className="p-4 bg-blue-50 rounded-lg">
                <div className="flex items-start justify-between">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">3. Check Pipeline</h4>
                    <p className="text-gray-700 text-sm">Where your deals are (stages)</p>
                    <p className="text-sm text-gray-600 mt-2 italic">
          ...
          {/* Throughout the Day */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-gray-900 mb-4 bg-green-50 p-3 rounded-lg border-l-4 border-green-500">
              THROUGHOUT THE DAY
            </h3>
            <div className="space-y-6 ml-4">
              <div>
                <h4 className="font-semibold text-gray-900 mb-3">When a New Lead Comes In</h4>
                ...
                <p className="text-xs text-gray-600 mt-2 ml-8 italic">Why: You now have a record. You won't forget this lead.</p>
              </div>

              <div>
                <h4 className="font-semibold text-gray-900 mb-3">When Someone is Ready to Buy</h4>
                <ol className="space-y-2 text-sm text-gray-700">
                  <li className="flex gap-3">
                    <span className="font-bold text-green-600">1.</span>
                ...
                <p className="text-xs text-gray-600 mt-2 ml-8 italic">Why: System enforces that every deal links to a product. No phantom revenue.</p>
              </div>

              <div>
                <h4 className="font-semibold text-gray-900 mb-3">When You Close a Deal</h4>
                <ol className="space-y-2 text-sm text-gray-700">
                  <li className="flex gap-3">
                    <span className="font-bold text-green-600">1.</span>
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-3">When Money Arrives</h4>
                <ol className="space-y-2 text-sm text-gray-700">
                  <li className="flex gap-3">
                    <span className="font-bold text-green-600">1.</span>
                ...
                <p className="text-xs text-gray-600 mt-2 ml-8 italic">Why: Allocating prevents reckless spending. Vault builds security.</p>
              </div>
            </div>
          </div>
          ...
          {/* End of Day */}
          <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-4 bg-purple-50 p-3 rounded-lg border-l-4 border-purple-500">
            ...
            <p className="text-xs text-gray-600 mt-2 ml-4 italic">Why: Clean slate for tomorrow. No tasks left behind.</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Weekly Routine (Monday Morning)</h2>
          </div>
          <div className="space-y-4">
            <div className="p-4 bg-purple-50 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-2">1. Review Last Week's Performance</h4>
              <p className="text-sm text-gray-700 mb-2">Check revenue, expenses, net profit, top systems, top clients</p>
              <p className="text-xs text-gray-600 italic">Action: Identify which products are selling. Double down on winners.</p>
            </div>

            <div className="p-4 bg-purple-50 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-2">2. Pipeline Health</h4>
              <p className="text-sm text-gray-700 mb-2">Deals in each stage? Any stuck for &gt;2 weeks? Projected value?</p>
              <p className="text-xs text-gray-600 italic">Action: For stuck deals, call to move forward or mark lost.</p>
            </div>

            <div className="p-4 bg-purple-50 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-2">3. Prospect Pipeline</h4>
              <p className="text-sm text-gray-700 mb-2">Prospects in each stage? Conversion rate? Average time to convert?</p>
              <p className="text-xs text-gray-600 italic">Action: If conversion rate &lt; 20%, improve pitch or qualify better.</p>
            </div>

            <div className="p-4 bg-purple-50 rounded-lg">
              <h4 className="font-semibold text-gray-900 mb-2">4. Financial Goals</h4>
              <p className="text-sm text-gray-700 mb-2">Check vault balance</p>
              <p className="text-xs text-gray-600 italic">Goal: Vault = 6 months operating expenses. If below, increase allocation %.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Key Metrics to Track</h2>
          </div>

          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Primary Metrics (Check Daily)</h3>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={i} className="border-b">
                      ...
                      <td className="p-3 text-gray-600"><Link href={row.where} className="text-blue-600 hover:underline">{row.where}</Link></td>
                      <td className="p-3 text-gray-600">{row.means}</td>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Secondary Metrics (Check Weekly)</h3>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gray-100">
        ...
        {/* Rules to Live By */}
        <div className="bg-white rounded-xl p-8 shadow-sm mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Rules to Live By</h2>
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Common Scenarios</h2>
          </div>

          <div className="space-y-4">
            <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
              <h4 className="font-semibold text-gray-900 mb-2">Deal is Stuck (3+ weeks)</h4>
              ...
              <p className="text-xs text-gray-600 italic">Why: Deals don't close themselves. Follow up aggressively.</p>
            </div>

            <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
              <h4 className="font-semibold text-gray-900 mb-2">Prospect Goes Cold (no response to 3 emails)</h4>
              <p className="text-sm text-gray-700 mb-2">
                <strong>Action:</strong> Try different channel (call if emailed, WhatsApp if called). If still no response after 7 days, archive.
              </p>
              <p className="text-xs text-gray-600 italic">Why: Don't waste time on unresponsive leads.</p>
            </div>

            <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
              <h4 className="font-semibold text-gray-900 mb-2">Client Hasn't Paid (contract active, no payment)</h4>
              <p className="text-sm text-gray-700 mb-2">
              ...
              <p className="text-xs text-gray-600 italic">Why: Cash flow is critical.</p>
            </div>

            <div className="p-4 bg-red-50 rounded-lg border border-red-200">
              <h4 className="font-semibold text-gray-900 mb-2">Vault is Low (&lt;1 month expenses)</h4>
              <p className="text-sm text-gray-700 mb-2">
