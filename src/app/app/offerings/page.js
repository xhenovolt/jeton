  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {showForm && (
        <form onSubmit={submit} className="bg-white rounded-xl border p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm text-gray-600 mb-1">Default Price</label>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 text-gray-400">No offerings yet. Add your products and services.</div>
      ) : (
            ...
            <div key={o.id} className="bg-white rounded-xl border p-5">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-1">
                  <button onClick={() => startEdit(o)} className="p-1 hover:bg-gray-100 rounded"><Edit className="w-4 h-4 text-gray-400" /></button>
                  <button onClick={() => deleteOffering(o.id)} className="p-1 hover:bg-red-50 rounded"><Trash2 className="w-4 h-4 text-gray-400 hover:text-red-600" /></button>
                </div>
              </div>
