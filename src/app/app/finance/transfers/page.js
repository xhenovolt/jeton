    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">{transfers.length} transfers</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 text-gray-400">No transfers yet</div>
      ) : (
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-medium text-gray-900">
                    {t.from_account_name} <span className="text-gray-400 mx-1">→</span> {t.to_account_name}
                  </div>
